...
const SOCIAL_LINKS = [
  { label: "LinkedIn", href: "https://www.linkedin.com/in/sakshiagarwalla" },
  { label: "GitHub", href: "https://github.com/sakshiagarwalla" },
  { label: "Twitter", href: "https://twitter.com/sakshiagarwalla" }
];
